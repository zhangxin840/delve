...
$(function(){		
	...
	$("#cards").children().each(function(index) {		
		...
		// the pattern value is actually a CSS playerClass with the
		// corrisponding playing card graphic.
		$(this).find(".back").addplayerClass(pattern);
...
function checkPattern()
{
	if (isMatchPattern())
	{
		$(".card-flipped").removeplayerClass("card-flipped").addplayerClass("card-removed");
	...
	{
		$(".card-flipped").removeplayerClass("card-flipped");
	}
}
